"""
Overhead 4b: Measure DP AllReduce with INTRA-NODE alpha/beta.
Run with torchrun on 2 GPUs same node.
"""
...
if __name__ == "__main__":
    ...
    if dist.get_rank() == 0:
        print("=" * 60)
        print("DP AllReduce Overhead Measurement (INTRA-NODE)")
        print("=" * 60)
    ...
    # Use INTRA-NODE alpha/beta (measured on your cluster)
    alpha = 104e-6   # seconds (alpha_intra)
    beta = 0.043e-9  # s/byte (beta_intra)
